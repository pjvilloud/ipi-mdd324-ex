  ...
  $.ajax(
    {
        ...
        str += '<div class="progress"><div class="progress-bar" role="progressbar" style="width: '+(data.jourAnnee/366)+'%;" aria-valuenow="'+data.jourAnnee+'" aria-valuemin="1" aria-valuemax="365">Jour '+data.joursAnnees+'</div></div>';
