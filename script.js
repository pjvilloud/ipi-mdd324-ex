  ...
  $.ajax(
    {
        ...
        str += '<div class="progress"><div class="progress-bar" role="progressbar" style="width: '+(366/data.jourAnnee)+'%;" aria-valuenow="'+data.jourAnnee+'" aria-valuemin="1" aria-valuemax="365">Jour '+data.joursAnnees+'</div></div>';
